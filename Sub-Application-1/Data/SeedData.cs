		...
		public static void Initialize(AppDbContext context)
		{
			...
			if (!context.Users.Any())
			{
				context.Users.AddRange(
					new User { UserName = "barbie koala", Email = "barbie@example.com", ProfilePictureUrl = "/images/seed/user1.jpg" },
					...
					new User { UserName = "duck face", Email = "ducky@example.com", ProfilePictureUrl = "/images/seed/user3.jpg", Bio = "I'm a duck, quack quack" },
					...
					new User { UserName = "mr Red", Email = "sara@example.com", ProfilePictureUrl = "/images/seed/user5.jpg" }
				);
				context.SaveChanges();
			}
