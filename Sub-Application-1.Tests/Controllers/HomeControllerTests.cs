...
namespace Sub_Application_1.Tests.Controllers
{
	public class HomeControllerTests
	{
		...
		public async Task CreatePost_ValidPost_SavesToDatabaseAndSavesFile()
		{
			...
			var controller = new HomeController(_postRepositoryMock.Object, _userRepositoryMock.Object, _webHostEnvironmentMock.Object, _loggerMock.Object)
			{
		...
		public async Task Index_WithPosts_ReturnsPostsList()
		{
			...
			var controller = new HomeController(_postRepositoryMock.Object, _userRepositoryMock.Object, null!, _loggerMock.Object)
			{
				ControllerContext = new ControllerContext
				{
					HttpContext = new DefaultHttpContext
