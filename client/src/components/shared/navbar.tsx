            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        {isLoggedIn ? (
                            <>
                                <Nav.Link href={`/profile/${username}`} className="mx-2 text-secondary">Profile</Nav.Link>
                                <Nav.Link href="/settings" className="mx-2 text-secondary">Settings</Nav.Link>
                                <Nav.Link href="/" onClick={logout} className="mx-2 text-secondary">Logout</Nav.Link>
                            </>
                        ) : (
